...
@Component({
  ...
  templateUrl: './create-otro-serv.component.html',
  styleUrl: './create-otro-serv.component.scss'
})
export class CreateOtroServComponent implements OnInit{
  ...
  postSubmit() {
       if (this.ServForm.valid)
      {
        ...
        formData.append('location', this.ServForm.get('location')?.value);
        formData.append('contactinf', this.ServForm.get('contactinf')?.value);
