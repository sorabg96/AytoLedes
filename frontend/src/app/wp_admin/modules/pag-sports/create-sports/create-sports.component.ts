...
@Component({
  ...
  styleUrl: './create-sports.component.scss'
})
export class CreateSportsComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    if(this.getparamid){
      this.service.getSingleData(this.table,this.getparamid).subscribe((res)=>{
          //console.log(res,'res==>');
          this.sportsAreaForm.patchValue({
  ...
  postSubmit() {
       if (this.sportsAreaForm.valid)
      {
        //console.log(this.sportsAreaForm.value)

        const formData: any = new FormData();
        formData.append('title', this.sportsAreaForm.get('title')?.value);
        formData.append('location', this.sportsAreaForm.get('location')?.value);
        formData.append('contactinf', this.sportsAreaForm.get('contactinf')?.value);
        formData.append('image', this.image);
        formData.append('description', this.sportsAreaForm.get('description')?.value);
  ...
  postUpdate()
  {
       if (this.sportsAreaForm.valid)
      {
        ...
        if(this.changedImage){
          ...
          formData.append('image', this.sportsAreaForm.get('image')?.value);
        }
