...
@Component({
    selector: 'app-serv-muni',
    standalone: true,
    templateUrl: './serv-muni.component.html',
    styleUrl: './serv-muni.component.scss',
    imports: [CommonModule, HttpClientModule, MatCardModule, MatIconModule, FooterwComponent]
})
export class ServMuniComponent implements OnInit{
  ...
  //Api-list-conection Navegation
      ...
      ngOnInit(): void {
        ...
        setTimeout(() => {
          for (let index = 0; index < this.MSData.length; index++) {
